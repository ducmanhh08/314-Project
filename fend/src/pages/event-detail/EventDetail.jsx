                ...
                <div className={styles['ticket-section']}>
                    <div className={styles['pricing-container']}>
                        <div className={styles['pricing-list']}>
                            ...
                            <div className={styles['category-price']}>
                                <span className={styles['tier']}>Premium Front Row</span>
                                <span className={styles['price']}>$ 2,900</span>
                            </div>
                            <div className={styles['category-price']}>
                                <span className={styles['tier']}>Gold Tier</span>
                                <span className={styles['price']}>$ 2,200</span>
                            </div>
                            <div className={styles['category-price']}>
                                <span className={styles['tier']}>Silver Tier</span>
                                <span className={styles['price']}>$ 1,600</span>
                            </div>
                            <div className={styles['category-price']}>
                                <span className={styles['tier']}>Bronze Tier</span>
                                <span className={styles['price']}>$ 1,200</span>
                            </div>
                            <div className={styles['category-price']}>
                                <span className={styles['tier']}>Balcony Seating</span>
                                <span className={styles['price']}>$ 850</span>
                            </div>
                            <div className={styles['category-price']}>
