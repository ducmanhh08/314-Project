...
const WaitingList3 = () => {
    ...
    return (
        <div>
           ...
           <div className="event-detail-container-3">
            ...
            <div className="text-section-3">
                ...
                <h2 className="contact-title-3">Contact Information</h2>

                <form className="contact-form-3">
                ...
                <p className="waitlist-disclaimer-3">
            ...
            {/* RIGHT COLUMN: IMAGE */}
            <div className="poster-container-3">
            <img
                src="/images/pottery.jpg"
                alt="Event Poster"
                className="event-poster-3"
            />

            {/* ✅ ORDER SUMMARY GOES DIRECTLY BELOW IMAGE */}
            <div className="order-summary-3">
                <h3 className="order-title-3">Order Summary</h3>
                <div className="order-details-3">
                    <div>1 x Waitlist Entry</div>
                    <div>A$0.00</div>
                </div>
                <div className="order-details-3 total">
                    <strong>Total</strong>
                    <strong>A$0.00</strong>
                </div>
                <button className="checkout-btn-3">CHECKOUT</button>
            </div>
        </div>
